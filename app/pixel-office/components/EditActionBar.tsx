...
export function EditActionBar({ isDirty, canUndo, canRedo, layoutWriteEnabled, onUndo, onRedo, onSave, onReset }: EditActionBarProps) {
  const { t } = useI18n()
  ...
  return (
    <div style={{
      ...
      {isDirty && layoutWriteEnabled ? (
        ...
        <span style={{ ...barBtnStyle, cursor: 'default', opacity: 0.7 }}>
          Layout read-only
        </span>
      ) : null}
    </div>
