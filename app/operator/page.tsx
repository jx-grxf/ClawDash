    ...
    <main className="space-y-6">
      <section className="rounded-[28px] border border-[var(--border)] bg-[var(--card-strong)] p-6">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-semibold">Schnellcheck für OpenClaw</h2>
            <p className="mt-2 text-sm text-[var(--text-muted)]">
              Gateway, Cron, Agent-Zustand und aktuelle Nutzung auf einen Blick.
            </p>
          </div>
      ...
      <section className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-[28px] border border-[var(--border)] bg-[var(--card)] p-5">
            ...
            <div className="mt-4 space-y-3">
              ...
              {needsAttention.length === 0 ? (
                <p className="text-sm text-[var(--text-muted)]">Alles ruhig. Keine direkten Auffälligkeiten.</p>
              ) : null}
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <CronJobsSummary />
          <div className="rounded-[28px] border border-[var(--border)] bg-[var(--card)] p-5">
            <h3 className="text-xl font-semibold">Kurzinfo</h3>
            <p className="mt-2 text-sm text-[var(--text-muted)]">
              Das ist der schnelle Betriebsblick. Für Detailanalysen nimm Sessions und Stats.
            </p>
          </div>
        </div>
      </section>
